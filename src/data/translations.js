...
export const translations = {
  en: {
    ...
    subtitle: "Generate high-quality, detailed prompts for stock photography, video, and Midjourney based on July 2025 trending categories and latest AI model parameters",
    ...
    aboutApp: "About App",
    aboutContent: {
      line1: "🎯 Adobe Stock Generator: Creates prompts optimized for stock photography based on July 2025 trending categories",
      line2: "🤖 Midjourney Integration: Full V7 support with latest parameters and Discord format", 
      line3: "🎲 Smart Randomization: Each generation creates unique prompts that never repeat",
      line4: "📊 Research-Based: Built on July 2025 market trends and dimensional design data"
    },
    ...
    howToContent: {
      ...
      step4a: "Generate Prompts - Uses YOUR selected settings with unique variations",
      step4b: "Random All Categories - Completely randomizes everything for maximum variety",
    ...
    proTips: "Pro Tips",
    tipsContent: {
      line1: "💡 Updated: Enhanced with July 2025 trending business objects & isolated backgrounds",
      line2: "🎨 Midjourney: V7 requires personalization unlock, V6.1 is default",
      line3: "📐 Aspect Ratios: 16:9 for landscapes, 9:16 for mobile, 1:1 for social",
      line4: "🎲 Each generation is unique - no more repeated prompts!",
      line5: "🎯 True randomization ensures fresh results every time",
      line6: "🚫 Enhanced Negative Prompts: Auto-excludes all living creatures, text, logos, watermarks",
      line7: "📱 Clean Assets: Perfect for business use with isolated white backgrounds",
      line8: "⚠️ Important: If any living creatures appear in generated images, please remove manually"
    },
    ...
    excludeHelp: "Additional elements to avoid (auto-excludes: people, animals, plants, text, logos, watermarks)",
    ...
    randomAllTooltip: "Completely randomize ALL settings and generate unique mixed category prompts",
    settings: "Settings",
    generating: "Generating...",
    generatePrompts: "Generate Prompts",
    generateTooltip: "Generate unique prompts using YOUR settings - never repeats!",
    ...
    footer: {
      description: "🎯 July 2025 Trending Assets • 🚫 No living creatures • ✨ Isolated white backgrounds • 🤖 Latest AI parameters • 💼 Business-ready prompts",
    ...
    notifications: {
      randomized: "🎲 All settings randomized & generating unique mixed category prompts...",
      settingsApplied: "✅ Settings applied successfully!",
      allCopied: "📋 All prompts copied to clipboard!",
      uniqueGeneration: "✨ Generated completely unique prompts with July 2025 trending assets - no repetition!"
    },
  ...
  id: {
    ...
    subtitle: "Buat prompt berkualitas tinggi dan detail untuk fotografi stok, video, dan Midjourney berdasarkan kategori trending Juli 2025 dan parameter model AI terbaru",
    ...
    aboutContent: {
      line1: "🎯 Generator Adobe Stock: Membuat prompt yang dioptimalkan untuk fotografi stok berdasarkan kategori trending Juli 2025",
      line2: "🤖 Integrasi Midjourney: Dukungan penuh V7 dengan parameter terbaru dan format Discord",
      line3: "🎲 Randomisasi Cerdas: Setiap generasi membuat prompt unik yang tidak pernah berulang",
      line4: "📊 Berbasis Riset: Dibangun berdasarkan tren pasar Juli 2025 dan data desain dimensional"
    },
    ...
    howToContent: {
      ...
      step4b: "Random Semua Kategori - Randomize semuanya untuk variasi maksimal",
    ...
    proTips: "Tips Pro",
    tipsContent: {
      line1: "💡 Update: Diperkaya dengan objek bisnis trending Juli 2025 & background isolated",
      line2: "🎨 Midjourney: V7 butuh unlock personalisasi, V6.1 adalah default",
      line3: "📐 Rasio Aspek: 16:9 untuk landscape, 9:16 untuk mobile, 1:1 untuk sosial",
      line4: "🎲 Setiap generasi unik - tidak ada lagi prompt berulang!",
      line5: "🎯 Randomisasi sejati memastikan hasil fresh setiap saat",
      line6: "🚫 Negative Prompt Canggih: Otomatis kecualikan semua makhluk hidup, text, logo, watermark",
      line7: "📱 Asset Bersih: Sempurna untuk bisnis dengan background putih isolated",
      line8: "⚠️ Penting: Jika ada makhluk hidup muncul di gambar hasil, mohon dihapus manual"
    },
    ...
    excludeHelp: "Elemen tambahan yang dihindari (otomatis dikecualikan: orang, hewan, tumbuhan, text, logo, watermark)",
    ...
    randomAllTooltip: "Randomize semua pengaturan dan buat prompt kategori campur otomatis",
    settings: "Pengaturan",
    generating: "Membuat...",
    generatePrompts: "Buat Prompt",
    generateTooltip: "Buat prompt unik menggunakan pengaturan ANDA - tidak pernah berulang!",
    ...
    footer: {
      description: "🎯 Asset Trending Juli 2025 • 🚫 Tanpa makhluk hidup • ✨ Background putih isolated • 🤖 Parameter AI terbaru • 💼 Prompt siap bisnis",
      freeMessage: "Tools ini gratis & terbuka untuk semua!",
      supportMessage: "Dukungan Anda membantu maintenance server & menambah fitur baru",
      coffeeButton: "🎁 Belikan saya kopi"
    },
    
    notifications: {
      randomized: "🎲 Semua pengaturan di-random & membuat prompt kategori campur...",
      settingsApplied: "✅ Pengaturan berhasil diterapkan!",
      allCopied: "📋 Semua prompt berhasil di-copy ke clipboard!",
      uniqueGeneration: "✨ Berhasil membuat prompt unik dengan asset trending Juli 2025 - tidak ada pengulangan!"
    },

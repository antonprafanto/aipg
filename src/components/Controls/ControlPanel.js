...
import { Camera, Video, Settings, Shuffle, RefreshCw, Zap, Target, Edit3, Bot } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        {onShowAISettings && (
          <button
            ...
            className="bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white font-semibold py-4 px-6 rounded-2xl transition-all duration-300 flex items-center gap-3 shadow-lg hover:shadow-xl"
            title="Configure AI Enhancement"
          >
            <Bot size={20} />
            AI Setup
          </button>
